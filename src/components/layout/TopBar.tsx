...
const viewTitles: Record<ViewType, { title: string; subtitle: string }> = {
  dashboard: { title: 'Training Dashboard', subtitle: 'Your ICS security learning journey' },
  'attraction-hmi': { title: 'Attraction Simulator', subtitle: 'Live PLC monitoring and control interface' },
  'security-training': { title: 'Module 2: Security Controls', subtitle: 'Configure firewalls, protocols, and access controls' },
  'defense-validator': { title: 'Defense Tester', subtitle: 'Validate your security configurations against attacks' },
  'architecture-training': { title: 'Module 1: Architecture Fundamentals', subtitle: 'Learn zones, segmentation, and the Purdue model' },
  ...
  'sis-protection': { title: 'Module 3: Safety Systems', subtitle: 'SIS protection, fail-safe design, and redundancy' },
  ...
  'scenario-simulator': { title: 'Module 4: Attack & Defense', subtitle: 'Simulate attacks and test your defenses' },
  ...
  'iec-62443': { title: 'Module 5: Compliance & Standards', subtitle: 'IEC 62443 and NIST CSF frameworks' },
  ...
  'saic-vs-cia': { title: 'SAIC vs CIA', subtitle: 'Safety vs security priority inversion' },
  'protocol-reference': { title: 'Protocol Reference', subtitle: 'Modbus, Ethernet/IP, ProfiNET technical specs' },
  glossary: { title: 'Glossary', subtitle: 'ICS terminology and definitions' },
  'interview-mode': { title: 'Interview Prep', subtitle: 'Practice explaining ICS security concepts' },
};
